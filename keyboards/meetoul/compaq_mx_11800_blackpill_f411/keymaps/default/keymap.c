...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [0] = LAYOUT_def(
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,       KC_INS,  KC_HOME, KC_PGUP, KC_PSCR,      KC_MPLY,                   KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
        ...
        KC_LCTL,     KC_LALT,                             KC_SPC,                                 KC_LWIN,     KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    )
};
